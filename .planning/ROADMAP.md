...
**Plans**: 15 plans (Wave 순서: Wave 0 → Wave 1 → Wave 2 spike & 검증 → Wave 3 swap)
  ...
  - [~] 01-16-PLAN.md — **측정 신뢰도 trace spike** — spike_measurement_trace (RTMPose+MB / MP+MB 양 엔진 frame-by-frame + 좌우 비대칭 + cross-engine disagreement + 4 가설 verdict) T-1~T-5 executor 완료 (42 PASS). T-6 belle Pod live mode (ref-invert 단독) 대기. multi-view 영구 제외 박제. (Wave 2, NEW 2026-06-01, **Plan 14 진입 gate, pending_belle_live**)
