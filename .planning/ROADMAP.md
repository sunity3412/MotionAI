...
- [ ] 28-04-PLAN.md — 파이프라인 방출 배선(mode1+mode3 second+) + 채점 무접촉 테스트 (wave 3, 27-06 후)
- [ ] 28-05-PLAN.md — fault_zoom D-04: fps 정합(표시 전용)+근사 제거+전신 폴백+refMatch (wave 3)
- [ ] 28-06-PLAN.md — VideoCompare 워핑 소비: targetRefTime 단일 경유+rate feedforward+tier 배지 (wave 3)
