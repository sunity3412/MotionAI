...
Last activity: 2026-09-03 저녁 - 확대비교 마감: 앱 = topFix 인라인(f2w)·저신뢰 예상 부위 카드 전부(ftg)·접힌 행 사진 전부(lr6) → 통과 사진은 동작별 전부 인라인, 참고 카드는 belle × 되돌림. 백엔드 = 눈 관절 힌트(jka)·중간 관절 한정+다수결(jxn)·몸통 관절 눈 제외(lpl), 클라임 라이브 PASS. 앱 커밋 8개 미빌드(1.2.4 대기, OTA 금지) · 백엔드 커밋 6개 미배포(Pod bundle 반입 필요, lpl 2개는 라이브 미확인). 게이트 tsc 0 · node --test 219/0 · pytest 4589/0. belle 판정 완료: 움직이는 순간 사진 = 버려(멈춤 60°/s 규칙 유지) · 감점 0 영상 사진 = 안 보여줌 — 둘 다 코드 변경 0. 확대비교 미결 0. **1.2.4 빌드 완료**(iOS 40 FINISHED + TestFlight 자동 제출 예약 · Android APK https://expo.dev/artifacts/eas/6kMTha1woYQQqo_mQFIu4vo2WF1ux37b4aePKXDc1jk.apk). 남은 것 = 백엔드 6커밋 Pod 반입·lpl 라이브 확인·푸시(belle 몫)
