...
Last activity: 2026-09-03 낮 - 확대비교 앱 배선 완성 2건(260903-f2w topFix 인라인 + 260903-ftg IN-01 경로 사진 카드 전부). ★belle pdshape doc 은 IN-01 저신뢰 경로라 topFix 카드가 원래 안 그려짐 — 확대비교 실물은 "예상 부위 (참고)" 카드 2장으로 시뮬 PASS(belle 이 copy-analysis-to-sim.mjs 실행해 줌). 앱 커밋 6개 미빌드(1.2.4 대기, OTA 금지). 게이트 tsc 0 · node --test 219/0. 표 3 잔여 = 행 2 클라임 eye(belle ○×)·행 3 advisory 노출(belle 판정)·행 5 사후 스테이지 순서(belle 승인). 백엔드 4572/0 무변경
