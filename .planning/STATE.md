...
Last activity: 2026-07-02 -- quick 260702-o0c Pod sweep GATE FAIL → REVERTED (00d19a5/c927286). window-median silent seed 가 success 위양성(74~92) 유발. kip-up fault 50 으로 상체 감점 메커니즘 자체는 실증. 다음=vision-pointed 관절만 window 측정하는 재설계(별도 phase 후보)
