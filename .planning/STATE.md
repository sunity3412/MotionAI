...
Last activity: 2026-09-02 새벽 - 로딩 단축(260901-wbo) 완료. ★다음 Pod E2E 체크리스트(누적): ①파워스핀·킵업 페어 재실행(08-31 이월) ②eye 오클루전 수리 실검증(belle 영상 재분석 → 확정 카드 doc 생존) ③coach 사후화 실검증(done 조기 도착·placeholder→승격·1.2.1 교차) ④연속 업로드 GPU 경합 분리는 미착수 별건. 백엔드 기준선 4572/0 · 앱 212/0 · 앱 1.2.2 두 플랫폼 발행(iOS 빌드36 TestFlight 제출 완료)
