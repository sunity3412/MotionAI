...
Last activity: 2026-09-01 - 기계 눈 오클루전 FP 수리(260901-vlu) 완료 — 확대비교 칸 소멸의 진범. 백엔드 기준선 4548/0 으로 갱신. 로딩 회계 완료(로딩 화면 ~2분10초, coach_dual 43s 최대, 사후 4스테이지 ~150s 는 화면 밖. 미계측 hook ~14s·사후 분리·코칭 사후화는 belle 답 대기). 앱 1.2.2 두 플랫폼 빌드 FINISHED, iOS TestFlight 제출 진행
