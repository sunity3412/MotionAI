...
<task type="auto">
  ...
  <acceptance_criteria>
    ...
    - app/tsconfig.json 이 corrective_exercises.json import 위해 resolveJsonModule 활성화 (3차 HIGH-2)
