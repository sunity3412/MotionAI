...
| 24-02-T2 | 24-02 | 2 | SCORE-10, SCORE-13, SCORE-14, SCORE-15, SCORE-16 | T-24-04, T-24-05, T-24-06 | tally fed measured overallScore+deviations (no 100−Gemini); per-move baseline_kind derived; result['deductionBreakdown'] set+validated in complete_analysis (no kwarg); nested-array validator; no silent no-op (WARNING+audit) | unit/integration | `cd backend && python -m pytest tests/test_pipeline_deduction_seam.py -x -q` | ❌ W0 | ⬜ pending |
| 24-02-T3 | 24-02 | 2 | SCORE-16 | — | capApplied band field retired→tallyFinal across 3-way contract + result.tsx consumer migrated | unit | `cd app && npx tsc --noEmit` + `grep -L capApplied app/src/types/analysis.ts` | ❌ W0 | ⬜ pending |
| 24-02-T4 | 24-02 | 2 | SCORE-10, SCORE-16, SCORE-09 | T-24-05, T-24-06 | math-determinism; baseline_kind derived; gemini-silent<100 (Phase 20 preserved); Mode3/toggle preserved | integration | `cd backend && python -m pytest tests/test_pipeline_deduction_seam.py -x -q && python -m pytest tests/ -q` | ❌ W0 | ⬜ pending |
