...
GUIDE_R2 = (
    ...
    "the raised ghost leg reaching up beside the pole with its softly bent knee, and "
    "the lower ghost leg reaching down and forward at a diagonal with its softly "
    "bent knee, the split stopping clearly short of one straight vertical line - do "
    "not invent new ghost leg positions, trace the FIRST image's legs - the two "
    "ghost legs must be clearly separate, never merged into one, and each ghost leg "
    "must stay clearly distinct from the pole, never blending into the pole or "
    "doubling the pole line; and (2) the solid, fully drawn 'after' legs corrected "
    "into ONE straight vertical line along the pole - the raised leg fully "
    "straightened up alongside the pole and the lower leg pressed straight down "
    "toward the floor, both knees fully extended, clearly MORE open than the ghost "
    "legs. The ghost is only the two legs; torso, arms, head and pole are drawn "
