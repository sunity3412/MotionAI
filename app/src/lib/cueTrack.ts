...
// → 음성2 정지" 끊김 해소.
//
// belle 08-07 밤 ④ (quick-260807-m63) — 1.0 → 0.3 축소. "④가 점프하듯 옮겨짐 —
// 제 순간까지 재생하는 것이 원칙, 체인은 재생 시간이 사실상 0인 겹침 전용".
// 수치 근거: 엘보 ③9.35s→④10.36s(간격 1.01s, 윈도우 1.6s 기준 ④ 시작 9.56s —
// 멈춤 ~8.6s 에서 1.0 지평이면 9.56<=9.6 으로 체인돼 belle 의 "점프")는 제외되고,
// 파워스핀(시작 간격 0.11s — 멈춤 시각에 이미 열린 윈도우, startSec<=cL)은
// 유지되는 값.
export const CUE_CHAIN_HORIZON_SEC = 0.3;
