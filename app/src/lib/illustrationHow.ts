...
export const HOW_ANCHORS: Readonly<Record<string, HowAnchors>> = {
  ...
  // 몸이 깨져 보였다. 좌표 = ref-power-spin.jpg 720x964 격자 실측 (2026-08-24).
  'ref-power-spin': {
    kind: 'rotate',
    limbs: [
      // 윗다리 (폴 따라 위) — 부족하면 폴에서 떨어져 오른쪽으로 기운다 (시계 +1).
      {
        pivot: [310 / 720, 430 / 964],
        tip: [243 / 720, 88 / 964],
        clip: [
          [280 / 720, 470 / 964], [252 / 720, 300 / 964], [228 / 720, 140 / 964],
          [228 / 720, 72 / 964], [282 / 720, 68 / 964], [308 / 720, 140 / 964],
          [332 / 720, 300 / 964], [348 / 720, 445 / 964], [332 / 720, 472 / 964],
        ],
        inwardSign: 1,
      },
      // 아랫다리 (아래로 눌러 한 줄) — 부족하면 수평 쪽으로 들린다 (반시계 -1).
      {
        pivot: [330 / 720, 445 / 964],
        tip: [580 / 720, 655 / 964],
        clip: [
          [305 / 720, 425 / 964], [390 / 720, 450 / 964], [470 / 720, 515 / 964],
          [560 / 720, 605 / 964], [615 / 720, 655 / 964], [595 / 720, 705 / 964],
          [515 / 720, 650 / 964], [425 / 720, 570 / 964], [335 / 720, 500 / 964],
          [295 / 720, 462 / 964],
        ],
        inwardSign: -1,
      },
