...
// result.recommendedExercises (개수는 분석이 정한다 — 결함 1개면 1개, 상한 5.
...
export interface FaultZoomComparison {
   ...
   * 원본 영상 타임라인 초(9fps 프레임 배열 인덱스 / 실효 fps — quick-260813-u8i)로,
   * 백엔드가 crop PNG 에 베이크한 타임스탬프와 **같은 값**이다.
   *
...
export type AnalysisResult = ScoreSuppression & {
  ...
  // 다르다 (결함 1개면 1개, 상한 5 — belle 2026-09-10 / quick-260910-u67).
